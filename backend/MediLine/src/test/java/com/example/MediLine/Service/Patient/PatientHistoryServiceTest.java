...
public class PatientHistoryServiceTest {
    ...
    void getPerformedTestOrThrow_validTestAndPatient_returnsPerformedTest() {
        ...
        when(performedTestRepository.findByIdAndPatientId(1, 1))
    ...
    void getPerformedTestOrThrow_invalidTest_throwsException() {
        when(performedTestRepository.findByIdAndPatientId(1, 5))
    ...
    void getPrescriptionDetails_validInput_returnsCompleteDTO() {
        ...
        when(prescriptionRepository.findByPrescriptionIdAndPatientId(prescriptionId, patientId))
    ...
    void getPrescriptionDetails_prescriptionNotFound_throwsException() {
        when(prescriptionRepository.findByPrescriptionIdAndPatientId(1, 1))
                .thenReturn(Optional.empty());
