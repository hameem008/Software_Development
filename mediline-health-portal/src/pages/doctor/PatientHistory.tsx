...
const PatientHistory = () => {
  ...
  const patientPrescriptions = selectedPatient ? mockPrescriptions.filter(presc => presc.patientId === selectedPatient.id) : [];
  const patientTests = selectedPatient ? mockTestResults.filter(test => test.patientId === selectedPatient.id) : [];
      ...
      {selectedPatient ? (
                        ...
                        <div key={prescription.id} className="border rounded-lg p-4">
                          <div className="flex items-start justify-between mb-3">
                            ...
                            <Button 
                              ...
                              onClick={() => navigate(`/doctor/prescription/${prescription.id}/view`)}
                            >
                              View Full
                            </Button>
                          </div>
            ...
            <CardContent>
              <div className="flex space-x-3">
                <Button 
                  ...
                  onClick={() => navigate(`/doctor/prescriptions/create?patientId=${selectedPatient.id}`)}
                >
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-gray-600">Choose a patient from the list to view their medical history</p>
          </CardContent>
        </Card>
      )}
    </div>
